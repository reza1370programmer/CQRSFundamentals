    ...
    public class GetOrderByIdQueryHandler : IRequestHandler<GetOrderByIdQuery,Result<OrderQuery>>
    {
        ...
        request, CancellationToken cancellationToken)
        {
            ...
            SqlConnection(_connectionString.Value))
            {
               ...
               @"select o.[Id] as ordernumber,o._orderDate as date, 
               ...
               country, o.Address_Street as street, 
                ...
                oi._productName as productname, oi._units as units, 
                oi._unitPrice as unitprice, oi._pictureUrl as 
                pictureurl
                 FROM ordering.Orders o
                LEFT JOIN ordering.Orderitems oi ON o.Id = oi.orderid 
                LEFT JOIN ordering.orderstatus os on o._orderStatusId 
                = os.Id
                WHERE o.Id=@id"
                , new { request.Id }
                );
